...
namespace CampanhaBO
{

    /// <summary>
    /// Classe de Negocios da Tabela Campanha
    /// </summary>
    public class CampanhaBO : IBaseBO<CampanhaBO, int>
    {
        ...
        public CampanhaBO Insert(CampanhaBO pObject)
        {
            throw new NotImplementedException();
        }

        public CampanhaBO Update(CampanhaBO pObject)
        {
            throw new NotImplementedException();
        }

        public IList<CampanhaBO> ListForGrid(CampanhaBO pObject, int pNumRegPag, int pNumPagina, string pDesOrdem, out int pNumTotReg)
        {
            throw new NotImplementedException();
        }

        public IList<CampanhaBO> ListForLookup(CampanhaBO pObject)
        {
            throw new NotImplementedException();
        }

        CampanhaBO IBaseBO<CampanhaBO, int>.SelectByPK(int pChave)
        {
            throw new NotImplementedException();
        }
    ...
    {
        public object idCampanha { get; internal set; }
    }
}
